...
import utils_new.multipledownload.DownloadInfoManager;
...
//            info.threadNum = cursor.getInt(2);
    ...
    public synchronized void deleteInfoAll() {
        SQLiteDatabase db = getWritableDatabase();
        db.delete(DownloadProvider.DownloadTable.TABLE_NAME, null, null);
        db.delete(DownloadProvider.CacheTable.TABLE_NAME, null, null);
    }
