...
public class vmCall extends CBOViewModel<iCall> {
    ...
    public ArrayList<SpinnerModel> getItems() {
        ...
        try {
            ...
            if (getBuilder().getType().equals(CallType.DOCTOR)) {
            ...
            }else if (getBuilder().getType().equals(CallType.DOCTOR_REMAINDER)) {
            ...
            }else if (getBuilder().getType().equals(CallType.CHEMIST)){
            ...
            }else if (getBuilder().getType().equals(CallType.CHEMIST_REMINDER)){
