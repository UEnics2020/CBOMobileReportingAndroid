...
public class OtherExpense extends CustomActivity implements IOtherExpense,up_down_ftp.AdapterCallback {
    ...
    @Override
    public void onUpdateArea(ArrayList<MPopupData> fromArea) {

    }

    @Override
    public void onUpdateExpType(ArrayList<MPopupData> expTyp) {

    }

    @Override
    public void loadExpenseType(ArrayList<MPopupData> expTyp) {

    }

    @Override
    public void onUpdateView(String ID, String DCR_ID, String FROM_STATION, String TO_STATION, String EXP_TYPE, String FARE, String KM, String AMOUNT, String REMARK, String FILE_NAME) {
