...
public class DcrNewAdapter extends RecyclerView.Adapter<DcrNewAdapter.MyviewHolder>{
    ...
    String fmcgYn;
    String Report_PAID,DCR_id="";

    public DcrNewAdapter(Context mcontext, ArrayList<mDCR_Report> data,String Report_PAID,String DCR_id) {
...
//        }
        ...
        holder.TtlMissed_call.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ttlRetailer.putExtra("DCR_ID",DCR_id);
