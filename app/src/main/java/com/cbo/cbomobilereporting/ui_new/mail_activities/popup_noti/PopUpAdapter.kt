        ...
        fun onBindData(position: Int) {
            ...
            tvValue.setOnClickListener {
                if (arrayList!![position].pagE_CODE.equals("DR", ignoreCase = true)) {
                    ...
                    intent.putExtra("Title", arrayList!![position].tname)
                    ...
                    ttlche.putExtra("Title", arrayList!![position].tname)
                ...
                }else if(arrayList!![position].pagE_CODE.equals("DAIRY", ignoreCase = true)){
                    val intent = Intent(context, TotalDrRpt::class.java)
                    intent.putExtra("PAID", "")
                    intent.putExtra("DCR_ID", arrayList!![position].dcR_CODE)
                    intent.putExtra("date", "")
                    ...
                    intent.putExtra("Title", arrayList!![position].tname)
                    context!!.startActivity(intent)
                }else if(arrayList!![position].pagE_CODE.equals("POULTRY", ignoreCase = true)){
                    val intent = Intent(context, TotalDrRpt::class.java)
                    intent.putExtra("PAID", "")
                    intent.putExtra("DCR_ID", arrayList!![position].dcR_CODE)
                    intent.putExtra("date", "")
