...
public class ASpinCat extends RecyclerView.Adapter<ASpinCat.MySingleViewHolder> {
    ...
    ICatPopup recycleViewOnItemClickListener = null;

    public ASpinCat(Context context, ArrayList<MRetailerPopup> arrayList) {
    ...
    public void setOnClickListner(ICatPopup recycleViewOnItemClickListener) {
        ...
        public void onBindData(int position) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    recycleViewOnItemClickListener.onClick(view, (MRetailerPopup) arrayList.get(position), position);
                }
            });
        }
    }
