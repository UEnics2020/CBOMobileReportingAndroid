...
public class Outlet extends CustomActivity implements iOutlet{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewModel.setLEVEL_NO(getIntent().getStringExtra("iLEVEL_NO"));
        viewModel.setDOC_TYPE1(getIntent().getStringExtra("DOC_TYPE1"));
    ...
    public void onListUpdated(ArrayList<mOutlet> outlets) {
        ...
        outletAdaptor.setDashboard(viewModel.getDashboard());
        outletAdaptor.setLEVEL_NO(viewModel.getLEVEL_NO());
