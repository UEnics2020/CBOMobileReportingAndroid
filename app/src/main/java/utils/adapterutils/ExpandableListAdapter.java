...
//    }
    ...
    private void init_DA_type(TableLayout stk, int groupPosition) {
        ...
        if (MyCustumApplication.getInstance().getDataFrom_FMCG_PREFRENCE("EXPTA_MGRMANUALYN", "Y").equalsIgnoreCase("Y") && !customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(_context, "DA_TYPE", "").equalsIgnoreCase("L")) {
            if (!MyCustumApplication.getInstance().getDataFrom_FMCG_PREFRENCE("ACTUALFARE", "").equalsIgnoreCase("")) {
                tv22.setText(AddToCartView.toCurrency(String.format("%.2f", Double.parseDouble(MyCustumApplication.getInstance().getDataFrom_FMCG_PREFRENCE("ACTUALFARE", "")))));
            } else {
...
//        tv22.setText(AddToCartView.toCurrency(String.format("%.2f",Dis_val)));
        ...
        if (MyCustumApplication.getInstance().getDataFrom_FMCG_PREFRENCE("EXPTA_MGRMANUALYN", "Y").equalsIgnoreCase("Y") && !customVariablesAndMethod.getDataFrom_FMCG_PREFRENCE(_context, "DA_TYPE", "").equalsIgnoreCase("L")) {
            if (!MyCustumApplication.getInstance().getDataFrom_FMCG_PREFRENCE("ACTUALFARE", "").equalsIgnoreCase("")) {
                ...
                net_value = DA_val
                        + Double.parseDouble(MyCustumApplication.getInstance().getDataFrom_FMCG_PREFRENCE("ACTUALFARE", ""))
                        + other;
            } else {
                net_value = DA_val
                        + Dis_val
