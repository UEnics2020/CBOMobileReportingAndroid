...
public class ImageLoader {
	...
	public void DisplayImage1( ImageView imageView,String id,String visual_pdf,String item_name){


//		File path1 = new File(Environment.getExternalStorageDirectory(), "cbo/product/"+6+"_1"+".jpg");
...
//		File path = new File(Environment.getExternalStorageDirectory(), "cbo/"+1+".jpg");
		if(item_name.equals("CATALOG")){
			imageView.setImageResource(R.drawable.web_login_white);
		}else if(path1.exists())
		{
