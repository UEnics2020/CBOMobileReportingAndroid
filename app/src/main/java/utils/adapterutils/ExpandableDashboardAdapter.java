...
public class ExpandableDashboardAdapter extends BaseExpandableListAdapter {
    ...
    public View getChildView(int groupPosition, final int childPosition,
        ...
        if ( childText.get(childPosition).get("BG_COLOR") != null && !childText.get(childPosition).get("BG_COLOR").isEmpty()){
            row.setBackgroundColor(Color.parseColor(childText.get(childPosition).get("BG_COLOR")));
        }
